...
namespace Backend.Classes.Core
{
    class Fighter : Class
    {
        ...
        {
            BAB = Level;
            Class_Features.Add(new Fighter_Class_Features().Bonus_Feats(this));
        }

        public override void Level_02()
        {
            Class_Features.Add(new Fighter_Class_Features().Bonus_Feats(this));
            Class_Features.Add(new Fighter_Class_Features().Bravery(this));
        }

        public override void Level_03()
        {
            Class_Features.Add(new Fighter_Class_Features().Armor_Training(this));
        }
        ...
        {
            Class_Features.Add(new Fighter_Class_Features().Weapon_Training(this));
        }
        ...
        {
            Class_Features.Add(new Fighter_Class_Features().Armor_Mastery(this));
        }

        public override void Level_20()
        {
            Class_Features.Add(new Fighter_Class_Features().Bonus_Feats(this));
            Class_Features.Add(new Fighter_Class_Features().Weapon_Mastery(this));
        }
    }
}
